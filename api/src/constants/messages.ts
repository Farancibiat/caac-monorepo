export const MESSAGES = {
  200: {
    ...
    RESERVATION_RELEASED: 'Cupos liberados correctamente',
    ...
    RESERVATION_CONTEXT_RETRIEVED: 'Contexto de reservas obtenido correctamente',
    RESERVATION_ADMIN_CALENDAR_RETRIEVED: 'Calendario admin obtenido correctamente',
    RESERVATION_MONTH_OPENED: 'Mes abierto para reservas correctamente',
    RESERVATION_DAYS_CANCELLED: 'Días cancelados y reembolsos registrados',
    ...
    RESERVATION_CAPACITY_UPDATED: 'Cupos del día actualizados correctamente',
    ...
    USER_SOCIO_UPDATED: 'Estado de socio actualizado correctamente',
  },
  ...
  400: {
    ...
    RESERVATION_RELEASE_NONE_VALID: 'Ninguna de las reservas seleccionadas puede liberarse (solo futuras, no canceladas)',
    RESERVATION_INVALID_DATES: 'Las fechas deben ser del mes siguiente y días hábiles (Lun/Mié/Vie)',
    RESERVATION_DAY_NOT_AVAILABLE: 'Una o más fechas no están disponibles para reserva',
  ...
  500: {
    ...
    DATABASE_ACCESS_DENIED_ERROR: 'Error de acceso a la base de datos',
    DATABASE_AUTH_ERROR: 'Error de autenticación con la base de datos',
    DATABASE_CONNECTION_ERROR: 'Error de conexión con la base de datos',
    DATABASE_NOT_FOUND_ERROR: 'Base de datos no encontrada',
    DATABASE_TIMEOUT_ERROR: 'Timeout de conexión con la base de datos',
    ...
    PROFILE_CREATE_ERROR: 'Error al crear perfil',
